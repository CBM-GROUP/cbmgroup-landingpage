      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pb-20 pt-32 lg:px-8">
        <div className="w-full flex flex-col items-center text-center">
          ...
          <motion.p
            ...
            className="mt-8 max-w-2xl text-lg text-center leading-8 text-gray-600"
          >
          ...
          >
            <Link
              href="/companies"
              prefetch={false}
              className="group flex items-center gap-3 rounded-full bg-white px-6 py-3.5 font-semibold text-center text-black transition hover:bg-teal-300"
            >
              Explore our brands
              <ArrowDownRight
                size={18}
