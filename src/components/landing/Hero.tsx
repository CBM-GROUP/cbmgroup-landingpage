...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#f5f5f1] pb-12 pt-4 sm:pb-16 lg:pb-20">
      {/* Background Glow */}
      ...
      <div className="relative mx-auto -mt-20 w-full max-w-7xl px-4 pt-24 sm:-mt-24 sm:px-6 sm:pt-28 lg:px-8">
        {/* Main Hero Card in Company Color Theme */}
        <div className="relative overflow-hidden rounded-[2.2rem] border border-white/20 bg-[#36BEA3] px-6 py-12 shadow-[0_22px_60px_rgba(0,0,0,0.12)] backdrop-blur-sm sm:px-10 sm:py-16 lg:px-16 lg:py-20">
